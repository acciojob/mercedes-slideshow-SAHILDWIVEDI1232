...
const Slideshow = () => {
  const images = [
    ...
    "https://www.mercedes-benz.com/en/vehicles/mercedes-eq/eqs-suv/_jcr_content/root/verticalgallery_copy/parsys/verticalgalleryitem_546277676/image/MQ6-0-image-20220819111550/03-mercedes-benz-the-new-eqs-suv-x296-2021-1680x1680.jpeg"
  ];
